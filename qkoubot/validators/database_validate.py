import os
from static import SQLITE_DIR_PATH, USE_MYSQL, MYSQL_USERNAME, \
    MYSQL_PASSWORD, MYSQL_HOST, MYSQL_DATABASE_NAME


def db_path_validate():
    assert os.path.exists(SQLITE_DIR_PATH), "{path} is not exists."
    if USE_MYSQL:
